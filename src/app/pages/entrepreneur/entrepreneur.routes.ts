...
export const ENTREPRENEUR_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      { path: 'measmi', component: MeAsmi },
      { path: 'karnah', component: Karnah },
      { path: 'calendai', component: CalendAI },
      { path: 'nutri-navigator', component: NutriNavigator },
      { path: 'witness-platform', component: Witness },
